...
exports.validateCredentials = exports.getUserByUsername = exports.mockAuthenticate = exports.AuthService = exports.AuthError = void 0;
/* eslint-disable */
// @ts-nocheck
...
class AuthService {
    ...
    static async verifyJwt(token) {
        return new Promise((resolve, reject) => {
            jsonwebtoken_1.default.verify(token, process.env.JWT_SECRET || 'dev-secret', (err, decoded) => {
                if (err) {
                    reject(err);
                }
                else {
...
function mockAuthenticate(...args) { return { userId: 'test' }; }
...
async function getUserByUsername(username) {
    ...
    const maybe = svc.getUserByUsername?.(username);
